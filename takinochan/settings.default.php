...
//   O SQLite utiliza um arquivo como banco de dados, então você define apenas o caminho para esse arquivo.
define('TINYIB_DBDSN', 'sqlite:tinyib.db');     // Caminho para o arquivo do banco de dados SQLite

// As configurações relacionadas a MySQL/PostgreSQL não são necessárias para o SQLite, então você pode ignorá-las.
// Elas ficarão sem efeito no modo 'sqlite3'.
